...
public:
	...
	* \return 返回成功输出的字符长度，失败返回-1。
	*/
	int putShadingText(IplImage *img, const char    *text, CvPoint pos, CvScalar color, int shadingTime);
	
	void setShadingPre() { m_isShaded = false; }
